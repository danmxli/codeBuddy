    ...
    return (
        <div className="h-screen relative bg-neutral-800 overflow-scroll scrollbar-hide">
            <div className="p-2 bg-neutral-900 rounded-r-3xl">
                <button
                    className={`bg-neutral-500 text-neutral-300 font-semibold p-1 m-1 rounded ${fetchModel === 'bug_fix' ? 'bg-indigo-700' : ''}`}
                ...
                <button
                    className={`bg-neutral-500 text-neutral-300 font-semibold p-1 m-1 rounded ${fetchModel === 'pseudo_to_lang' ? 'bg-indigo-700' : ''}`}
                ...
                <button
                    className={`bg-neutral-500 text-neutral-300 font-semibold p-1 m-1 rounded ${fetchModel === 'code_explain' ? 'bg-indigo-700' : ''}`}
                ...
                <button
                    className={`bg-neutral-500 text-neutral-300 font-semibold p-1 m-1 rounded ${fetchModel === 'calc_complexity' ? 'bg-indigo-700' : ''}`}
